...
LOG_PATH = os.path.join(os.path.expanduser("~"), ".config", "send-email")
...
file_handler = RotatingFileHandler(
    os.path.join(os.path.expanduser(LOG_PATH), 'send-email.log'),
    maxBytes=1024*1024, 
    backupCount=3
)
...
def get_email_config() -> Dict[str, str]:
    ...
    Returns:
        Dict[str, str]: Email configuration dictionary.
    """
    ...
    config = {
        ...
        "smtp_security": os.environ.get("SMTP_SECURITY", "none").lower(),  # 'none', 'starttls', 'ssl'
